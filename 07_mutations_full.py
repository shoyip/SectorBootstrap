...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Propose mutations for a given model and for all alignments. Uses full alignment of serine proteases (260 positions).")
